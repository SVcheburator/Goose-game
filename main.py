...
def create_bonus():
    global bonus_size
    bonus_size = (90, 150)
    bonus = pygame.transform.scale(pygame.image.load('bonus.png'), (90, 150))
    bonus_rect = pygame.Rect(random.randint(0, WIDTH - bonus_size[0]), 0 - bonus_size[1], *bonus_size)
...
while playing:
    ...
    main_display.blit(FONT.render(str(score), True, COLOUR_BLACK), (WIDTH - 50, 20))
    ...
    for enemy in enemies:
        if enemy[1].left < 0 - enemy_size[0]:
